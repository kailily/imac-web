...
const ORGANIZATIONS = [{
  ...
  descLong: ["衔尾蛇事务所是异常初现后最早成立的专业异常处理组织之一，由三位幸存者共同创立。事务所的名称来源于他们的信念——「异常吞掉的，我们要从异常嘴里拿回来」。", "作为亚洲规模最大、人员最活跃的成员组织，衔尾蛇以其灵活务实的行事风格著称。他们不追求学院派的完美推演，而是强调「进去、活下去、带答案出来」。这种风格也让他们在复杂城市异常和叙事型异常中表现格外出色。", "事务所的成员多来自刑侦系统、痕迹学、行为分析学背景，善于从细微线索中还原规则全貌。他们与鸣海城警方保持着长期合作关系，在城市异常响应速度上位居全球前列。"],
  ...
  walkers: [{
    ...
    feat: "异常初现时期幸存者，专职叙事型异常心理防线建设，带出的新人同化率最低。"
  }],
  contact: {
    phone: "99-01",
  ...
  descLong: ["边界研究院（Boundary Research Institute，简称BRI）是全球历史最悠久的异常研究机构，成立于安珀历元年灰港事件后不久。其前身是多国联合成立的「异常现象调查委员会」。", "BRI的学术系统化程度全球最高，拥有最完整的异常档案库、最全面的分类体系和最严谨的训练流程——其溯界者培训周期长达14个月，是所有组织中最长的。", "BRI的战术分析组由退役军官和资深溯界者混编，专攻复杂规则型异常的破解。他们的方法论影响了整个行业，IMAC的标准规则解析框架即由BRI主导制定。"],
