        ...
        <Restricted level="internal" label="机密级内容" compact>
          <div className="internal-note">
            <p className="internal-note-text">
              【衔尾蛇事务所内部评估 · 行动档案】<br/><br/>
              一、态势：灰港异常处于活跃期，无扩张、无衰竭迹象。累计进入5次、32人次，生还8人、死亡24人，生还率约25%。<br/><br/>
              二、确认事项：<br/>
              1. 记忆特性属实。三名二次进入者的报告相互印证：再次进入时走廊灯光自亮、门自启，异常能识别来者。<br/>
              2. 铁门符号无法拓印、无法摄录、无法转述——判定为异常自我保护机制，列为长期观测项。<br/><br/>
              三、处置决定：<br/>
              1. 维持灰港遗址封闭管理。未经 IMAC 审批，任何组织不得进入。<br/>
              2. 二次进入者一律登记备案，进入前后强制接受心理评估。<br/>
              3. 保持最低限度接触，以远距监测与目击报告收集为主，不再组织主动探索。<br/><br/>
              四、关于「记忆上限」：暂不立项。在确认异常记忆范围之前，任何试探都意味着再付人命。先守住，再问为什么。<br/><br/>
              附言：首批九个人，只有我活着走出来，这条命是灰港还我的。三十九年了，我每年都去铁门前站一会儿——它一直记得我，就像我记得那八个人。这条档案往后无论谁接手，请替我记住一件事：它记得每一个来过的人，这句话不是威胁，是事实。
            </p>
    ...
    const outpostData = {
      ...
      internalNode: (
        <Restricted level="internal" label="机密级内容" compact>
          <div className="internal-note">
            <p className="internal-note-text">
              【北境守望内部评估 · 行动档案 · 冻土探索营】<br/><br/>
              一、态势：冰封哨站，时间停滞型异常，安珀历21年第四批行动成功坍缩，已解决。
              四批累计55人进入，生还17人、死亡38人。<br/><br/>
              二、确认事项：<br/>
              1. 核心锚点可被干预：拨动地下室机械钟摆（停摆于23:47）后异常整体坍缩——「锚点-解冻」机制成立。<br/>
              2. 冻结环境下保持清醒决策的人，是处置成功的关键；装备与火力无法替代。<br/><br/>
              三、处置决定：<br/>
              1. 「冰封哨站处置流程」纳入北境守望训练教材。<br/>
              2. 白松城周边建立常驻监测哨，针对「钟表集体停走」前兆实行24小时值班。<br/>
              3. 同类前兆再次出现时，响应时间目标：24小时内完成集结。<br/><br/>
              附言：规程可以写成条目，但道理是冻土区教给我们的——拨动钟摆的力气谁都有，难的是在零下四十度的冻结环境里还能清醒地做决定。装备会失效，人不会，只要他还记得自己为什么站在那儿。
            </p>
    ...
    const loopData = {
      ...
      internalNode: (
        <Restricted level="internal" label="机密级内容" compact>
          <div className="internal-note">
            <p className="internal-note-text">
              【北境守望内部评估 · 行动档案 · 灰松岭行动队】<br/><br/>
              一、态势：灰松岭循环路段，空间循环型异常（常规级），安珀历38年冬发现，72小时内坍缩，已解决。
              被困车辆2车3人、处置队员4人，全员安全，无人员伤亡。<br/><br/>
              二、行动复盘：<br/>
              1. 快速处置成立的关键是及时上报：发现者未靠近、未拍摄传播，记下位置、退出路段、拨打99——平民处置流程正确。<br/>
              2. 异常等级不等于危险程度：本次仅造成车辆循环、未直接伤人，但同型异常升级风险不可排除。<br/><br/>
              三、处置决定：<br/>
              1. 「灰松岭处置流程」纳入北境守望快速响应训练案例。<br/>
              2. 维持周边短期监测至观测期结束，确认无复发后撤除临时警示。<br/>
              3. 继续向公众普及「发现-退出-上报」三步骤——本次行动的关键在于平民的正确应对。<br/><br/>
              附言：这次的功臣是那位伐木工人。他没好奇凑近，没拍视频发上网，记下位置、退出路段、拨了99——三件事，教科书里教的，他全做到了。我干了十五年北境，见过太多聪明人死在「再靠近一步」上。每个公民都该会这三件事。
            </p>
          ...
          <div className="detail-body">
            ...
            <div className="file-section">
              ...
              <div className="internal-note">
                <Restricted level="internal" label="机密级内容" compact>
                  <p className="internal-note-text">
                    【衔尾蛇事务所内部评估 · 行动档案 · 首席溯界者 陆沉舟】<br/><br/>
                    一、态势：赤月学院，十一届进入，累计116人。无一人由规则直接致死——失踪、「剧情失败」消失、同化。
                    伤亡模式与常规深渊级异常不符：该异常不主动杀人，疑似具备选择性。<br/><br/>
                    二、研判：<br/>
                    1. 疑似「筛选」机制。接近核心区域（白玫瑰花园）的进入者，即使返回，状态均发生改变——倾向判定为针对性行为，而非随机杀伤。<br/>
                    2. 关键区域：白玫瑰花园。生还者状态变化与花园暴露程度呈正相关。<br/><br/>
                    三、处置：<br/>
                    1. 维持外围监测，不组织大规模进入。<br/>
                    2. 重点跟踪第十一届内部存活者信标状态——恢复正常或完全消失，均构成关键判据。<br/>
                    3. 待信标数据明朗后，由本所拟订介入方案，报 IMAC 审批。<br/><br/>
                    四、结论：该异常在等待某一条件满足。条件确认前，任何主动接近均按高风险行动处理。<br/><br/>
                    附言：档案要写得冷静，可我心里一直有个声音——它不是「陷阱」，是「谜题」。十一届，一百一十六人，没有一个是被规则直接杀死的，它更像在筛选什么。白玫瑰花园等的是一个会「毕业」的人。这是我的直觉，也是我唯一不敢写进条目的判断：我怕它是对的。
                  </p>
