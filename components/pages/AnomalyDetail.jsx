  ...
  if (isLoop) {
    ...
    const loopData = {
      ...
      info: [
        ...
        ["生还率", [<span key="s" style={{ color: "var(--level-ordinary)" }}>100%</span>, "（7人进入，0人死亡）"], "信息价值", "中"],
      ...
      phenomena: [
        "<strong>「坍缩条件」：</strong>在循环锚点（枯树）处完成规则干预后，异常整体坍缩，路段恢复正常通行，现场无异常残留——坍缩不是「被破坏」，而是规则被满足后异常自行闭合。",
  ...
  if (isShortcut) {
    const shortcutData = {
      ...
      info: [
        ...
        ["异常等级", { levelKey: "ordinary", text: "常规级 · ORDINARY" }, "当前状态", { statusKey: "safe", text: "● 安全 SAFE" }],
        ["生还率", [<span key="s" style={{ color: "var(--level-ordinary)" }}>100%</span>, "（应用13年 · 零事故）"], "信息价值", "民用应用示范样本"],
  ...
  if (isSlumber) {
    const slumberData = {
      ...
      info: [
        ...
        ["异常等级", { levelKey: "ordinary", text: "常规级 · ORDINARY" }, "当前状态", { statusKey: "safe", text: "● 安全 SAFE" }],
        ["生还率", [<span key="s" style={{ color: "var(--level-ordinary)" }}>100%</span>, "（应用15年 · 零事故）"], "信息价值", "民用应用示范样本"],
  ...
  if (isKettle) {
    const kettleData = {
      ...
      info: [
        ...
        ["异常等级", { levelKey: "ordinary", text: "常规级 · ORDINARY" }, "当前状态", { statusKey: "safe", text: "● 安全 SAFE" }],
        ["生还率", [<span key="s" style={{ color: "var(--level-ordinary)" }}>100%</span>, "（应用20年 · 零事故）"], "信息价值", "民用应用示范样本"],
  ...
  if (isHomeward) {
    const homewardData = {
      ...
      info: [
        ...
        ["异常等级", { levelKey: "ordinary", text: "常规级 · ORDINARY" }, "当前状态", { statusKey: "safe", text: "● 安全 SAFE" }],
        ["生还率", [<span key="s" style={{ color: "var(--level-ordinary)" }}>100%</span>, "（应用18年 · 零事故）"], "信息价值", "民用应用示范样本"],
  ...
  if (isSilent) {
    const silentData = {
      ...
      info: [
        ...
        ["异常等级", { levelKey: "ordinary", text: "常规级 · ORDINARY" }, "当前状态", { statusKey: "safe", text: "● 安全 SAFE" }],
        ["生还率", [<span key="s" style={{ color: "var(--level-ordinary)" }}>100%</span>, "（应用23年 · 零事故）"], "信息价值", "民用应用示范样本"],
