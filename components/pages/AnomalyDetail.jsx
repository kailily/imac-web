        ...
        <Restricted level="internal" label="机密级内容" compact>
          <div className="internal-note">
            <p className="internal-note-text">
              ...
              四、关于「记忆上限」：暂不立项。在确认异常记忆范围之前，任何试探都意味着再付人命。先守住，再问为什么。
            </p>
        ...
        <Restricted level="internal" label="机密级内容" compact>
          <div className="internal-note">
            <p className="internal-note-text">
              ...
              3. 继续向公众普及「发现-退出-上报」三步骤——本次行动的关键在于平民的正确应对。
            </p>
              ...
              <div className="internal-note">
                <Restricted level="internal" label="机密级内容" compact>
                  <p className="internal-note-text">
                    ...
                    四、结论：该异常在等待某一条件满足。条件确认前，任何主动接近均按高风险行动处理。
                  </p>
