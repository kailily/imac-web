  ...
  if (isShortcut) {
    const shortcutData = {
      ...
      info: [
        ...
        ["异常等级", { levelKey: "safe", text: "安全级 · SAFE" }, "当前状态", { statusKey: "applied", text: "● 应用中 APPLIED" }],
        ["生还率", [<span key="s" style={{ color: "var(--level-safe)" }}>100%</span>, "（应用13年 · 零事故）"], "信息价值", "民用应用示范样本"],
        ["档案更新", "安珀历39年 · 春", "处置状态", "民用应用 · 持续运营中"],
      ],
      discovery: [
        "安珀历26年春，鸣海城地铁三号线「南站—会展中心」区间施工时，盾构机在地下一处废弃管道内掘出一对「对门」：两扇相距二十八公里、造型相同的旧式铁门，分别嵌在管道两侧的岩壁里。工人推开其中一扇，竟从另一扇门里走了出来——施工日志记录了这一过程，全程不到三秒。",
        "衔尾蛇事务所在接到异常热线上报后接管现场，对两扇门进行了为期六个月的结构性研究，确认这是一处规则稳定、可重复触发的空间折叠型异常。经 IMAC 民用异常应用委员会评估，于安珀历27年正式立项为「捷径门」民用应用项目。",
      ],
      features: [
        "捷径门是一对<strong>规则稳定的空间折叠通道</strong>（安全级）：两扇门之间以空间折叠连接，通过者从一扇门进入、另一扇门走出，实际位移二十八公里，全程缩短为约三秒的「穿行」。",
      ...
      speculatedRules: [
        "两扇门之间的「穿行」疑似并非瞬移，而是将二十八公里路径压缩为折叠通道——通过者身体在通道内实际「走」过了这段距离，只是感知不到",
        "门的连接强度与季节有关：秋季校准期间连接最弱，疑似与「秋分」这一时间节点存在未被完全解析的关联",
      ...
      suggestedActions: [
        "维持年度校准与日常监测，持续收集「灰色走廊」目击报告（目前无任何风险记录）",
        "评估将同一应用模型推广至其他城市的可行性（需确认异常对「地理位置」的绑定条件）",
        "与地铁运营方联合开展每季度一次的安全演练，确保突发情况下的有序疏散",
      ],
      internalNode: (
        <Restricted level="internal" label="机密级内容" compact>
          <div className="internal-note">
            <p className="internal-note-text">
              【衔尾蛇事务所内部评估 · 民用异常应用处】<br/><br/>
              捷径门运营十三年，零事故，是我们最拿得出手的民用项目。但内部的结论必须写清楚：它「安全」，是因为我们守住了每一条规则——限重、间隔、持卡、校准，一条都没松过。<br/><br/>
              那2%的「灰色走廊」报告我们一直在跟进。目前没有任何数据表明它与风险相关，但也没有数据能解释它。按规矩，未解析的现象不上报公开档案——请继续盯住它，别让它变成档案里那句「后来……」。
            </p>
            <div className="internal-note-signature">— 衔尾蛇事务所 · 民用异常应用处 · 应用组组长</div>
          </div>
        </Restricted>
      ),
    };

    return <AnomalyDossier data={shortcutData} />;
  }
  ...
  if (isSlumber) {
    const slumberData = {
      ...
      info: [
        ...
        ["异常等级", { levelKey: "safe", text: "安全级 · SAFE" }, "当前状态", { statusKey: "applied", text: "● 应用中 APPLIED" }],
        ["生还率", [<span key="s" style={{ color: "var(--level-safe)" }}>100%</span>, "（应用15年 · 零事故）"], "信息价值", "民用应用示范样本"],
        ["档案更新", "安珀历39年 · 春", "处置状态", "民用应用 · 处方限量发放"],
      ],
      discovery: [
        "安珀历24年秋，白松城一名长期失眠的纺织厂女工向晨星团设立的社区异常咨询点求助：她家中一只旧枕头发现在特定睡姿下，能让她在数分钟内陷入「从未有过」的深度睡眠，醒来后精神焕发，且「完全记不起梦」。晨星团派员上门核实，确认该枕头为异常物品。",
        "经结构解析，异常被确认依附于枕头的材质与内部结构，而非使用者。晨星团在取得原主同意后，通过逐层复刻「规则载体」的方式实现了可控复制，经 IMAC 民用异常应用委员会评估后立项为「安眠枕」项目，于安珀历25年以处方形式向社会发放。",
      ],
      features: [
        "安眠枕是一只<strong>可复制的睡眠辅助型异常物品</strong>（安全级）：在绑定使用者的正确睡姿下，可使其在约3分钟内进入最深度的无梦睡眠，并于约90分钟后自然苏醒，醒来即精神饱满、无需再补觉。",
      ...
      speculatedRules: [
        "「90分钟唤醒」疑似不是异常自设的规则，而是它与人体生理节律的「共振点」——异常选择在深睡周期结束时唤醒使用者，而非其自身有固定周期",
        "复刻品与原始枕头的效果存在细微差异（复刻品入睡时间略长），暗示「规则载体」中仍有未被完全复刻的成分",
        "「晨间空白」现象与记忆整理阶段的交互机制尚未完全解析，但十五年数据未显示任何认知损伤",
      ],
      entryRecords: [
        { term: "试点发放", year: "安珀历25年·春", count: 120, org: "晨星团", result: "120人 · 全部正常使用", status: "safe" },
        { term: "正式应用", year: "安珀历27年", count: 4000, org: "晨星团/白松城医院", result: "累计约四千人 · 零事故", status: "safe" },
        { term: "随访至今", year: "安珀历39年", count: 0, org: "晨星团", result: "无认知损伤 · 无依赖报告", status: "safe" },
      ],
      phenomena: [
        "<strong>「无梦区间」：</strong>使用者普遍报告使用期间「完全记不起梦」——既非忘记，也非无梦，而是醒来后对睡眠过程毫无记忆，仿佛时间被直接「跳过」。该现象在复刻品上同样存在，程度略轻。",
        "<strong>「晨间空白」：</strong>醒来后约3分钟内，使用者处于清醒但「放空」的状态，可正常行动与应答，但之后无法回忆起这3分钟内的大部分内容。随访未发现该现象对日常造成影响。",
      ],
      ...
      suggestedActions: [
        "维持处方发放与年度随访制度，持续统计「晨间空白」与长期使用数据",
        "推进「规则载体」复刻精度研究，缩小复刻品与原始枕头的差异",
        "评估将安眠枕纳入公共心理健康服务体系的可行性（需扩大禁忌症筛查范围）",
      ],
      internalNode: (
        <Restricted level="internal" label="机密级内容" compact>
          <div className="internal-note">
            <p className="internal-note-text">
              【晨星团内部评估 · 民用物品应用科】<br/><br/>
              安眠枕是晨星团最安静的项目——它不惊险，不传奇，就是一只枕头，让四千个失眠的人好好睡了四千个晚上。<br/><br/>
              我们的结论很朴素：异常不一定是「危险的东西」。当它的规则被一条条解析清楚，当它的边界被一次次确认，它就可以像一把伞、一盏灯一样，成为生活的一部分。捷径门连接城市，安眠枕守护夜晚——这大概就是「民用应用」这四个字的意义。<br/><br/>
              唯一需要持续留意的，是「晨间空白」和那2%的复刻差异。目前所有数据都指向安全，但民用应用的原则是：宁可慢，不可松。
            </p>
            <div className="internal-note-signature">— 晨星团 · 民用物品应用科 · 科长 程一苇</div>
          </div>
        </Restricted>
      ),
    };

    return <AnomalyDossier data={slumberData} />;
  }
  ...
  if (isKettle) {
    const kettleData = {
      ...
      info: [
        ...
        ["异常等级", { levelKey: "safe", text: "安全级 · SAFE" }, "当前状态", { statusKey: "applied", text: "● 应用中 APPLIED" }],
        ["生还率", [<span key="s" style={{ color: "var(--level-safe)" }}>100%</span>, "（应用20年 · 零事故）"], "信息价值", "民用应用示范样本"],
        ["档案更新", "安珀历39年 · 春", "处置状态", "民用应用 · 定点配发"],
      ],
      discovery: [
        "安珀历19年冬，白松城一家老茶馆的老板发现，店里的旧铜壶永远保持着「刚好能喝」的温度——无论倒入什么、放置多久，揭开壶盖时总冒着恰到好处的热气。冬天客人多，老板起初以为是巧合，直到一位常客指出「这壶三年没烧过水了」才惊觉异常，遂通过社区热线上报。",
        "晨星团派员调查后确认该壶为异常物品，其规则载体依附于壶身铜质与内部结构。经逐层复刻实现可控复制后，由 IMAC 民用异常应用委员会立项为「恒温壶」项目，定点配发给社区养老服务站与医院保温餐使用。",
      ],
      features: [
        "恒温壶是一只<strong>温度锚定型异常物品</strong>（安全级）：任何液体倒入后约10分钟，温度即恒定为60℃±0.5℃，此后无论放置多久（实测最长72小时）温度不再变化，恰为「刚好能喝」的温度。",
      ...
      speculatedRules: [
        "「60℃」疑似不是异常自设的数值，而是它复刻了发现时茶馆老板的日常习惯——异常可能以「使用场景」为规则基础",
        "每日三次的限制疑似与茶馆「早中晚各烧一壶」的旧习对应，支持上述「场景复刻」假说",
        "原始铜壶的壶底在夜间会透出极淡的微光，复刻品上该现象明显减弱，疑为规则载体中未复刻的成分",
      ],
      entryRecords: [
        { term: "复刻验证", year: "安珀历19年·冬", count: 40, org: "晨星团", result: "40只复刻壶 · 全部稳定", status: "safe" },
        { term: "正式应用", year: "安珀历20年", count: 300, org: "晨星团/白松城民政", result: "配发300只 · 零事故", status: "safe" },
        { term: "随访至今", year: "安珀历39年", count: 0, org: "晨星团", result: "无失效 · 无副作用报告", status: "safe" },
      ],
      phenomena: [
        "<strong>「壶底微光」：</strong>夜间熄灯后，原始铜壶的壶底会透出极淡的暖色微光，温度越高越明显；复刻品上该现象已减弱至几乎不可见，其成因未被解析。",
        "<strong>「隔夜余温」：</strong>复刻壶在空置状态下，内壁仍会保持约两小时的「刚烧开过」的触感余温——这是应用中最实用的现象之一，也是使用者辨识恒温壶是否仍处于可用状态的方法。",
      ],
      imacNote: "恒温壶大概是 IMAC 档案里最「家常」的异常——一只替人把茶一直温着的壶。它证明了：异常遵循绝对的行为准则，而被完整解析的准则，可以安安静静地变成生活的一部分。请配发点严格遵守使用规则：每日三次、壶身完整、切勿用于冲调药物。",
      suggestedActions: [
        "维持定点配发与季度巡检，记录复刻壶的长期衰减情况",
        "推进「壶底微光」成因研究，评估其与规则载体的关联",
        "评估将恒温壶纳入偏远地区医疗巡诊保温用品的可行性",
      ],
      internalNode: (
        <Restricted level="internal" label="机密级内容" compact>
          <div className="internal-note">
            <p className="internal-note-text">
              【晨星团内部评估 · 民用物品应用科】<br/><br/>
              恒温壶是我们配发范围最广的项目之一，三百只壶在白松城转了二十年，没有一只出过问题。老百姓对它的评价很朴实：「这壶懂人」。<br/><br/>
              内部口径只有一句：它的「懂」，来源于规则的稳定，而规则的稳定来源于我们的克制——每日三次的配额我们从未放宽过，哪怕养老站的阿姨们抱怨冬天水凉得快。放宽的那天，就是档案里写下「后来……」的那天。
            </p>
            <div className="internal-note-signature">— 晨星团 · 民用物品应用科 · 配发组 组长 孟秋实</div>
          </div>
        </Restricted>
      ),
    };

    return <AnomalyDossier data={kettleData} />;
  }
  ...
  if (isHomeward) {
    const homewardData = {
      ...
      info: [
        ...
        ["异常等级", { levelKey: "safe", text: "安全级 · SAFE" }, "当前状态", { statusKey: "applied", text: "● 应用中 APPLIED" }],
        ["生还率", [<span key="s" style={{ color: "var(--level-safe)" }}>100%</span>, "（应用18年 · 零事故）"], "信息价值", "民用应用示范样本"],
        ["档案更新", "安珀历39年 · 春", "处置状态", "民用应用 · 定向发放"],
      ],
      discovery: [
        "安珀历21年冬，北境冻原一名猎人在暴风雪中迷失方向，凭借口袋里一枚捡来的灰色卵石「一路被牵着」走回了营地——事后他坚称「石头在带路」。长桥会社调查组循此线索在冻原冰层下找到一块与卵石同源的岩层，确认卵石为异常物品。",
        "经解析，异常依附于卵石的矿物结构，具有「以佩戴者为锚、指向归途」的稳定规则。长桥会社在取得完整数据后，与北境守望合作启动了「归途石」定向发放项目，最初用于极地作业人员的防迷路保障。",
      ],
      features: [
        "归途石是一枚<strong>方向锚定型异常物品</strong>（安全级）：佩戴者在陌生环境中会持续产生「朝某方向走」的清晰直觉，该方向始终指向佩戴者登记在案的「家」——实测在半径五公里内准确无误。",
      ...
      speculatedRules: [
        "石头的「家」锚定疑似与佩戴者登记时的「记忆」而非坐标有关——少数更换住址的佩戴者，在登记更新前仍被指向旧地址",
        "方向提示的强度与距离成正比：离家越远，掌心处的温热感越明显，实测在五公里边界处温热感达到峰值",
        "夜间佩戴者的行走稳定性明显优于白天，疑似异常对「视觉」之外的方位感知存在增益",
      ],
      entryRecords: [
        { term: "极地试点", year: "安珀历21年·冬", count: 60, org: "长桥会社/北境守望", result: "60人 · 全部正常", status: "safe" },
        { term: "社区发放", year: "安珀历24年", count: 800, org: "长桥会社", result: "发放800枚 · 零事故", status: "safe" },
        { term: "随访至今", year: "安珀历39年", count: 0, org: "长桥会社", result: "无失效 · 无副作用报告", status: "safe" },
      ],
      phenomena: [
        "<strong>「掌心微热」：</strong>佩戴期间，归途石在掌心持续保持约体温的温度；离家越远越热，方向正确时热度平稳，方向错误时热度轻微起伏——常被佩戴者称为「石头在叹气」。",
        "<strong>「夜路本能」：</strong>夜间或浓雾中，归途石佩戴者的步态稳定性显著提升，平衡能力接近白天水准；机理未被解析，但与「方向增益」疑似同源。",
      ],
      imacNote: "归途石让八百多名老人和野外工作者不再害怕「找不到回家的路」——这大概是「民用异常应用」最温暖的含义。请佩戴者牢记两条规则：石头只告诉你方向，路况要靠自己看；如果家搬了，记得先到管理站更新登记。",
      suggestedActions: [
        "维持定向发放与年度登记复核，确保「家」的锚定与佩戴者现住址一致",
        "与医疗机构合作，评估归途石在阿尔茨海默症早期干预中的应用价值",
        "持续收集「夜路本能」数据，探索其与方向增益的共性机理",
      ],
      internalNode: (
        <Restricted level="internal" label="机密级内容" compact>
          <div className="internal-note">
            <p className="internal-note-text">
              【长桥会社内部评估 · 民用社区应用部】<br/><br/>
              归途石是我们的招牌项目，但签发放协议时，我们每次都要反复叮嘱家属一句话：它是「指路」的，不是「保命」的。<br/><br/>
              有位老太太的家属问过我们：「有它在，我妈是不是就不会走丢了？」我们只能说：它会带她回家，但它拦不住她过河。方向是异常的规则，安全是人的责任——这句话，希望每一个佩戴者的家人都能记住。<br/><br/>
              石头本身十八年没有出过任何问题。有问题的是我们对「边界」的表述——请继续把边界说清楚，这是这个项目唯一的底线。
            </p>
            <div className="internal-note-signature">— 长桥会社 · 民用社区应用部 · 部长 沈砚舟</div>
          </div>
        </Restricted>
      ),
    };

    return <AnomalyDossier data={homewardData} />;
  }
  ...
  if (isSilent) {
    const silentData = {
      ...
      info: [
        ...
        ["异常等级", { levelKey: "safe", text: "安全级 · SAFE" }, "当前状态", { statusKey: "applied", text: "● 应用中 APPLIED" }],
        ["生还率", [<span key="s" style={{ color: "var(--level-safe)" }}>100%</span>, "（应用23年 · 零事故）"], "信息价值", "民用应用示范样本"],
        ["档案更新", "安珀历39年 · 春", "处置状态", "民用应用 · 场馆配发"],
      ],
      discovery: [
        "安珀历16年夏，洛林自由市旧剧院翻修时，工人在后台储物间发现一块深灰色毛毯，展开铺平后整个房间的噪音「消失了」——说话声在毯内清晰，毯外几乎听不见。剧院经理起初以为是隔音改造的效果，直到工程师告诉他「这堵墙根本不可能隔音」才上报。",
        "边界研究院（BRI）接手调查，确认毛毯为异常物品，其规则载体依附于织物结构与纤维排布。经复刻验证后，由 IMAC 民用异常应用委员会立项为「静音毯」项目，按场馆定点配发。",
      ],
      features: [
        "静音毯是一块<strong>降噪型异常织物</strong>（安全级）：展开铺平后，以毯中心为圆心、半径两米内的环境噪音被抑制至约18分贝（相当于安静图书馆的耳语水平），毯内人声清晰可辨，毯外几乎听不见。",
      ...
      speculatedRules: [
        "降噪范围恒为「半径两米」疑似与毛毯的物理尺寸存在比例关系——更大的复刻样本（2.4m×3m）范围扩大至半径2.6米，比例关系未被完全解析",
        "「8小时限制」疑似对应旧剧院后台「每场演出前后清理」的作息，支持异常以「使用场景」为规则基础的假说",
        "毯子的纤维排布在显微镜下呈现规律性的环形结构，BRI 推测这是规则载体的物理形态，但复刻工艺仍依赖原毯采样",
      ],
      entryRecords: [
        { term: "复刻验证", year: "安珀历17年", count: 30, org: "边界研究院", result: "30张复刻毯 · 全部稳定", status: "safe" },
        { term: "正式应用", year: "安珀历18年", count: 120, org: "BRI/洛林市立图书馆", result: "配发120张 · 零事故", status: "safe" },
        { term: "随访至今", year: "安珀历39年", count: 0, org: "边界研究院", result: "无失效 · 无副作用报告", status: "safe" },
      ],
      phenomena: [
        "<strong>「毯缘风感」：</strong>站在降噪范围边缘的使用者普遍报告能感到一层「极轻的、贴着皮肤掠过的风」，跨过边界时「啪」地一下像过了一道薄膜；该风感无温度、无方向，来源未被解析。",
        "<strong>「无声泡泡」：</strong>毯内完全安静时，使用者偶尔会听到一声极其轻微的「啵」——像泡泡破裂，疑似为降噪边界与外部声波的相互作用，无风险记录。",
      ],
      imacNote: "静音毯把「安静」变成了一件可以展开铺平的东西：图书馆的读者、咨询室的来访者、考场的考生，都能在半径两米内获得一份不受打扰的安宁。请使用单位务必遵守：展开使用、记录时长、警报备份——安静是福祉，安全是底线。",
      suggestedActions: [
        "维持场馆定点配发与使用时长台账，落实「警报备份」专项检查",
        "继续「规则载体」纤维结构的复刻精度研究，扩大样本覆盖范围",
        "评估静音毯在新生儿病房与临终关怀病房的应用可行性（需经伦理审查）",
      ],
      internalNode: (
        <Restricted level="internal" label="机密级内容" compact>
          <div className="internal-note">
            <p className="internal-note-text">
              【边界研究院内部评估 · 民用技术应用部】<br/><br/>
              静音毯二十三年来最让我警惕的不是毯子本身，而是使用单位对「安静」的依赖——有家图书馆曾差点把火警报警器也「放进」毯子里，理由是「报警声太吵」被读者投诉。<br/><br/>
              我们当时连夜撤了那套方案。安静是这只异常给世界的礼物，但安全是IMAC给人类的承诺——两者永远不能互换。<br/><br/>
              技术上，纤维环形结构的复刻精度我们已经做到97%以上，剩下的3%差在「毯缘风感」上。不着急，规则没解析完，就继续守着原毯过日子。
            </p>
            <div className="internal-note-signature">— 边界研究院 · 民用技术应用部 · 研究员 顾望舒</div>
          </div>
        </Restricted>
      ),
    };
