  ...
  const news = [
    {
      ...
      content: [
        ...
        "北境守望第三支队于接报后6小时内抵达现场，封锁路段并设立临时安全边界。经过初步勘查，该异常影响范围约为2.3公里的山区路段，异常等级判定为常规级（SPA-0421）。",
        "行动历时共72小时，分为三个阶段：",
    ...
    },
    {
      ...
      content: [
        ...
        "经勘查，该异常为典型的「循环站台」型空间异常（SPA-1132，危险级）。异常的核心特征是：列车在两个相邻站点之间行驶时，会不断回到出发站台，形成一个封闭的循环空间。",
        "处置过程分为两步：",
