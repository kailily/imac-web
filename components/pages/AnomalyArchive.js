...
function AnomalyArchivePage({
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("style", null, `
    ...
    }, a.status === "safe" && "● 安全", a.status === "active" && (a.statusText === "待命" ? "● 待命" : "● 活跃"), a.status === "resolved" && "● 已解决", a.status === "quarantined" && "● 隔离中"), /*#__PURE__*/React.createElement("div", {
      className: `archive-row-survival ${parseFloat(a.survival) < 10 ? "level-text-abyssal" : parseFloat(a.survival) < 50 ? "level-text-hazardous" : "level-text-ordinary"}`,
      style: {
        "--s": a.survival
      }
