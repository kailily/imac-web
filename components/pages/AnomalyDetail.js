...
function AnomalyDetailPage() {
  ...
  if (isKettle) {
    const kettleData = {
      ...
      features: ["恒温壶是一只<strong>温度锚定型异常物品</strong>（安全级）：任何液体倒入后约10分钟，温度即恒定为60℃±0.5℃，此后无论放置多久（实测最长72小时）温度不再变化，恰为「刚好能喝」的温度。", "「恒温壶」项目由晨星团民用物品应用科管理，目前以定点配发方式服务于白松城及周边十余个社区的养老服务站与医院保温餐，应用二十年零事故。"],
      verifiedRules: [{
        num: "一",
        title: "温度锚定",
      ...
      speculatedRules: ["「60℃」疑似不是异常自设的数值，而是它复刻了发现时茶馆老板的日常习惯——异常可能以「使用场景」为规则基础", "每日三次的限制疑似与茶馆「早中晚各烧一壶」的旧习对应，支持上述「场景复刻」假说", "原始铜壶的壶底在夜间会透出极淡的微光，复刻品上该现象明显减弱，疑为规则载体中未复刻的成分"],
      entryRecords: [{
        term: "复刻验证",
        year: "安珀历19年·冬",
        count: 40,
  ...
  if (isHomeward) {
    const homewardData = {
      ...
      features: ["归途石是一枚<strong>方向锚定型异常物品</strong>（安全级）：佩戴者在陌生环境中会持续产生「朝某方向走」的清晰直觉，该方向始终指向佩戴者登记在案的「家」——实测在半径五公里内准确无误。", "「归途石」项目由长桥会社民用社区应用部管理，目前主要定向发放给阿尔茨海默症早期患者、极地作业人员与野外勘探队，应用十八年零事故。"],
      verifiedRules: [{
        num: "一",
        title: "绑定佩戴",
      ...
      speculatedRules: ["石头的「家」锚定疑似与佩戴者登记时的「记忆」而非坐标有关——少数更换住址的佩戴者，在登记更新前仍被指向旧地址", "方向提示的强度与距离成正比：离家越远，掌心处的温热感越明显，实测在五公里边界处温热感达到峰值", "夜间佩戴者的行走稳定性明显优于白天，疑似异常对「视觉」之外的方位感知存在增益"],
      entryRecords: [{
        term: "极地试点",
        year: "安珀历21年·冬",
        count: 60,
  ...
  if (isSilent) {
    const silentData = {
      ...
      features: ["静音毯是一块<strong>降噪型异常织物</strong>（安全级）：展开铺平后，以毯中心为圆心、半径两米内的环境噪音被抑制至约18分贝（相当于安静图书馆的耳语水平），毯内人声清晰可辨，毯外几乎听不见。", "「静音毯」项目由边界研究院民用技术应用部管理，目前配发于洛林自由市的公共图书馆静音区、心理诊所咨询室与考试中心，应用二十三年零事故。"],
      verifiedRules: [{
        num: "一",
        title: "展开生效",
      ...
      speculatedRules: ["降噪范围恒为「半径两米」疑似与毛毯的物理尺寸存在比例关系——更大的复刻样本（2.4m×3m）范围扩大至半径2.6米，比例关系未被完全解析", "「8小时限制」疑似对应旧剧院后台「每场演出前后清理」的作息，支持异常以「使用场景」为规则基础的假说", "毯子的纤维排布在显微镜下呈现规律性的环形结构，BRI 推测这是规则载体的物理形态，但复刻工艺仍依赖原毯采样"],
      entryRecords: [{
        term: "复刻验证",
        year: "安珀历17年",
        count: 30,
