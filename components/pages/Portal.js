...
function PortalPage() {
  ...
  const announcements = [{
    ...
    source: "衔尾蛇事务所",
    content: ["IMAC联合行动指挥中心、各缔约组织：", "现将第十一届赤月学院异常介入行动（行动代号：赤月·XI）进展情况通报如下：", "一、行动概况：本次行动由衔尾蛇事务所与边界研究院联合派遣，共计溯界者4人（衔尾蛇2人、BRI 2人），行动指挥为资深溯界者沈彻。小队于安珀历39年夏·26日从东侧主入口进入，初始阶段进展顺利。", "二、当前状态：夏·29日起与小队失去常规通讯联系，锚定信标信号微弱但稳定，判定为'进行中·全员失联'状态。按《联合行动失联处置规程》第3.1条，暂不启动搜救程序，持续监测信标信号。", "三、后续安排：技术局每日3次校准信标定位；预备队（衔尾蛇一组 + BRI支援组）保持二级待命；下一次状态评估定于秋·10。后续进展将及时通报。"]
  }, {
