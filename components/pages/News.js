function NewsPage() {
  ...
  const news = [{
    ...
    level: "public",
    tag: "事件通报",
    content: ["本报导经IMAC信息协调办公室三层审定，确认可公开披露。", "安珀历39年春季，白松城以南约47公里处的107省道出现异常现象：车辆行驶至该路段时，GPS信号会突然丢失，随后车辆在不知不觉中回到起点，形成一条不断循环的路段。当地交管部门在接到多起「迷路」报告后，初步判断为规则型异常，并立即上报IMAC区域协调中心。", "北境守望第三支队于接报后6小时内抵达现场，封锁路段并设立临时安全边界。经过初步勘查，该异常影响范围约为2.3公里的山区路段，异常等级判定为常规级（SPA-0421）。", "行动历时共72小时，分为三个阶段：", "第一阶段（前24小时）：规则解析组通过投放无人探测装置与标记物，确认该异常的核心规则为「视线封闭循环」——当驾驶员在弯道处失去对前方直路的视线时，空间会发生折叠式重置。", "第二阶段（中间24小时）：处置组采用「连续视距锚定法」，在关键弯道处设置高亮度信标阵列，打破循环触发条件。", "第三阶段（最后24小时）：溯源组沿异常能量轨迹逆向追踪，在一处废弃的护林员小屋中找到异常源头——一面老旧的圆形铜镜。铜镜安全封存后，异常现象随即消散。", "本次行动共安全撤离受困平民7人，无溯界者伤亡。被困人员均已接受心理评估，其中2人出现轻度定向障碍，预计一周内可完全恢复。"],
  ...
  }, "\u8BA2\u9605")))))), /*#__PURE__*/React.createElement("div", {
