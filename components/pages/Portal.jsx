  ...
  const announcements = [
    {
      ...
      content: [
        ...
        "一、参训范围：衔尾蛇事务所、边界研究院BRI、北境守望、晨星团在编溯界者（含见习期），共计约210人；上季度外勤出勤率低于60%者强制参训。",
    ...
    },
    {
      ...
      content: [
        ...
        "一、行动概况：本次行动由衔尾蛇事务所与边界研究院BRI联合派遣，共计溯界者4人（衔尾蛇2人、BRI 2人），行动指挥为资深溯界者沈彻。小队于安珀历39年夏·26日从东侧主入口进入，初始阶段进展顺利。",
